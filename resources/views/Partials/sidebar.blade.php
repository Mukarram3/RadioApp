                    ...
                    <ul class="menu-subnav">
                        <li class="menu-item menu-item-parent" aria-haspopup="true">
                                    <span class="menu-link">
                                        <span class="menu-text">Create Algorithm</span>
                                    </span>
                        </li>
                        <li class="menu-item" aria-haspopup="true">
                            <a href="{{ url('/admin/home/slider') }}" class="menu-link">
...
<path d="M12,15 C13.6568542,15 15,13.6568542 15,12 C15,10.3431458 13.6568542,9 12,9 C10.3431458,9 9,10.3431458 9,12 C9,13.6568542 10.3431458,15 12,15 Z" fill="#000000"/>
                ...
                <div class="menu-submenu" kt-hidden-height="120" style="">
                    ...
                    <ul class="menu-subnav">
                        ...
                        <li class="menu-item" aria-haspopup="true">
                            <a href="{{ url('/ourcompany') }}" class="menu-link">
                                <i class="menu-bullet menu-bullet-dot">
                                    <span></span>
                                </i>
                                <span class="menu-text">Our Company Details</span>
                            </a>
                        </li>
                        <li class="menu-item" aria-haspopup="true">
                            <a href="{{ url('/ourhistory') }}" class="menu-link">
                                <i class="menu-bullet menu-bullet-dot">
                                    <span></span>
                                </i>
