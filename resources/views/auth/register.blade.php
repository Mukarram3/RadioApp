...
<html lang="en">
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="login login-3 wizard d-flex flex-column flex-lg-row flex-column-fluid">
				...
				<div class="login-aside d-flex flex-column flex-row-auto">
					...
					<!--end::Aside Top-->
					<!--begin::Aside Bottom-->
					<div class="aside-img d-flex flex-row-fluid bgi-no-repeat bgi-position-x-center" style="background-position-y: calc(60%); background-image: url(assets/media/svg/illustrations/login-visual-5.svg)"></div>
					<!--end::Aside Bottom-->
				</div>
				<!--begin::Aside-->
				<!--begin::Content-->
                        ...
                        <div class="col-lg-7 col-md-8 col-sm-10">
							...
							<form method="POST" action="{{ route('register') }}" class="form" id="kt_login_singin_form">
                                ...
                                <div class="form-group">
									<label class="font-size-h6 font-weight-bolder text-dark">Your First Name</label>
									<input type="text" class="form-control h-auto py-7 px-6 rounded-lg border-0" @error('fname') is-invalid @enderror name="fname" value="{{ old('fname') }}" required autocomplete="fname" autofocus />
                                    @error('fname')
                                ...
                                <div class="form-group">
									<label class="font-size-h6 font-weight-bolder text-dark">Your Last Name</label>
									<input type="text" class="form-control h-auto py-7 px-6 rounded-lg border-0" @error('lname') is-invalid @enderror name="lname" value="{{ old('lname') }}" required autocomplete="lname" autofocus />
                                    @error('lname')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
								...
								<div class="form-group">
									...
									<input type="password" class="form-control h-auto py-7 px-6 rounded-lg border-0" class="@error('password') is-invalid @enderror" name="password" required autocomplete="new-password"/>
                                    @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group">
									...
									<input type="password" class="form-control h-auto py-7 px-6 rounded-lg border-0" name="password_confirmation" required autocomplete="new-password"/>
		...
		<script src="{{ asset('assets/js/pages/login-3.js?v=7.0.5') }}"></script>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->
</html>
