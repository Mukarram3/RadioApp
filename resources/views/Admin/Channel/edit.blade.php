            ...
            <div class="container">
                <div class="card card-custom">
                    <div class="card-body">
                        ...
                        <form class="form" method="post" enctype="multipart/form-data" action="{{ route('update.channel.details') }}">
                            @csrf
                            <input type="hidden" value="{{ $channelDetails->id }}" name="channel_id" >
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <select class="form-control form-control" name="status" id="exampleSelect2">
                                            <option value="">Choose Status</option>
                                                <option value="1" {{ old('status', $channelDetails->status) == '1' ? 'selected' : '' }}>Active</option>
                                                <option value="0" {{ old('status', $channelDetails->status) == '0' ? 'selected' : '' }}>Disable</option>
                                        </select>
                                    </div>
                                    <div class="col-lg-6">
                                        <label>Type:</label>
                            ...
                            <div class="card-footer">
                                <div class="row">
                                    {{-- <img width="50px" height="50px" class="image" /> --}}
                                    <div class="col-lg-6">
