            ...
            var table =  $('#kt_datatable').DataTable({
                     ...
                     columns:[
                        //  {data:'id', name:'id'},
                         ...
                         {data:'artist.name', name:'artist_id'},
                         {data:'date', name:'date'},
...
$(document).on('click','input[name="main_checkbox"]', function(){
           ...
           function toggledeleteAllBtn(){
               if( $('input[name="country_checkbox"]:checked').length > 0 ){
                   $('button#deleteAllBtn').text('UnSchedule ('+$('input[name="country_checkbox"]:checked').length+')').removeClass('d-none');
               }else{
                   $('button#deleteAllBtn').addClass('d-none');
               }
           }
                    ...
                    var url = '<?= route("delete.ScheduleArtist") ?>';

                    swal.fire({
                         title:'Are you sure?',
                         html:'You want to <b>UnSchedule</b> this Scheduled Artist',
                         showCancelButton:true,
                         showCloseButton:true,
                         cancelButtonText:'Cancel',
                         confirmButtonText:'Yes, Unschedule',
               ...
               var url = '{{ route("delete.selected.ScheduleArtist") }}';
               if(checkedCountries.length > 0){
                   swal.fire({
                       title:'Are you sure?',
                       html:'You want to UnSchedule <b>('+checkedCountries.length+')</b> Scheduled Artists',
                       showCancelButton:true,
                       showCloseButton:true,
                       confirmButtonText:'Yes, Unschedule',
                       cancelButtonText:'Cancel',
