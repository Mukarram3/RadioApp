		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="login login-3 wizard d-flex flex-column flex-lg-row flex-column-fluid">
				...
				<div class="login-aside d-flex flex-column flex-row-auto" style="padding: 0 2.5rem">
					...
					<!--end::Aside Top-->
					<!--begin::Aside Bottom-->
					<div class="aside-img d-flex flex-row-fluid bgi-no-repeat bgi-position-x-center" style="background-position-y: calc(100%); background-image: url(assets/media/svg/illustrations/login-visual-5.svg)"></div>
					<!--end::Aside Bottom-->
				</div>
				<!--begin::Aside-->
				<!--begin::Content-->
						...
						<div class="col-lg-7 col-md-8 col-sm-10">
							...
							<form method="POST" action="{{ route('login') }}" class="form" id="kt_login_singin_form">
								...
								<div class="form-group">
									...
									<input type="email" class="form-control h-auto py-7 px-6 rounded-lg border-0" @error('email') is-invalid @enderror name="email" value="{{ old('email') }}" required autocomplete="email" autofocus />
                                    @error('email')
								...
								<div class="form-group">
									...
									<input type="password" class="form-control h-auto py-7 px-6 rounded-lg border-0" @error('password') is-invalid @enderror name="password" required autocomplete="current-password"/>
                                    @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
